...
<template>
    ...
    <div class="mt-20">
        <el-input v-model="input3" placeholder="输入书名进行搜索" class="input-with-select">
            <template #append>
    ...
    <el-row :gutter="20" class="mt-20">
        ...
        <el-col :span="12" :offset="0">
            <el-select v-model="selectChapter" filterable value-key="chapterName" placeholder="选择章节"  @change="handleSelectChapter">
    ...
    <el-text>{{ content?.content }}</el-text>
</template>
